# Remap Manifest — mycelium-cli → cli
...
|---|---|---|---|---|---|---|
| `cli.bin.myc` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-cli/src/bin/myc.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
| `cli` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-cli/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
